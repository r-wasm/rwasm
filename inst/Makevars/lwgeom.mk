PKG_CPPFLAGS=-I$(WASM)/include -I$(WASM)/include/proj -Iliblwgeom -DHAVE_PROJ_H -DPOSTGIS_PROJ_VERSION=94 -DUSE_PROJ_H -DPOSTGIS_GEOS_VERSION=35 -DHAVE_LIBLWGEOM_INTERNAL_H
PKG_LIBS=-L$(WASM)/lib -lgeos -lgeos_c -lproj
